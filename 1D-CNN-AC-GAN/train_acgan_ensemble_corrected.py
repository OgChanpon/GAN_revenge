# train_acgan_ensemble_corrected.py
...
# ★ 成功時のAC-GAN設定に戻す ★
BATCH_SIZE = 64      # Batchサイズも戻す
LR_D = 0.000487      # 学習率を大きく戻す
LR_G = 0.000232
NUM_EPOCHS = 100     # Epoch数を100に戻す
NUM_MODELS = 5       # 5つのモデル
K_STEPS = 2
LABEL_REAL = 0.95
LABEL_FAKE = 0.08
...
# --- アンサンブル AC-GAN 学習ループ ---
print(f"\n=== AC-GAN Ensemble Training (Corrected) Start ({NUM_MODELS} models) ===")
...
for model_idx in range(NUM_MODELS):
    ...
    auxiliary_loss = FocalLoss(alpha=class_weights_tensor, gamma=2.0) # Pretrain時はGamma2.0で標準的に
